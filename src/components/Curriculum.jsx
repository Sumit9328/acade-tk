...
const Curriculum = () => {
  ...
  return (
    <section className="w-full bg-[#f0f2ff] py-[30px] min-h-[720px]">
            ...
            {modules.map((module, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute top-[39px] left-[190px] w-[50px] border-t-2 border-dotted border-black"></div>
                </div>
              );
            })}
          </div>
            ...
            {modules.map((module, index) => {
              ...
              return (
                <div
                  ...
                  mb-[14px] overflow-hidden
                  transition-all duration-300
                  ${isOpen ? "h-[307px]" : "h-[54px]"}`}
                >
                  {/* Accordion Header */}

                  <div
                    onClick={() => setOpenModule(isOpen ? null : index)}
                    className={`px-[15px] flex items-center justify-between cursor-pointer ${
                      isOpen ? "h-[54px] border-b border-gray-200" : "h-full"
                    }`}
                  >
                    <p className="text-[12px] leading-[17px] font-bold text-black pr-[10px]">
                      {module.title}
                    </p>
                  ...
                  {isOpen && (
                    <div className="px-[15px] pt-[8px] text-[12px] leading-[18px] text-[#333]">
                      {module.content}
                    </div>
                  )}
                </div>
          ...
          <div className="w-[295px] shrink-0">
            ...
            <div className="relative overflow-hidden rounded-[8px] bg-[#263e83] min-h-[400px]">
              ...
              <div className="relative h-[88px] bg-[#fca311]">
                <div className="absolute left-[95px] top-[8px]">
                  <h3 className="text-[16px] font-bold text-black">
                    Limited Seats Available!
                  </h3>

                  <div className="mt-[7px] bg-[#17376e] w-[200px] py-[5px]">
                    <p className="text-[12px] text-white font-bold pl-[8px]">
                      New Batch Starts
                    </p>
              ...
              <div
                className="absolute bottom-0 left-0 right-0 h-[315px]
              ...
              <div className="relative z-10 p-[15px]">
                ...
                <div className="h-[45px] border border-white/20 rounded-[8px] flex items-center justify-center text-white">
                  <div className="text-center">
                    <p className="text-[19px] font-bold">24</p>
                    <p className="text-[8px]">Days</p>
                  </div>

                  <span className="mx-[12px] text-[18px] font-bold">:</span>

                  <div className="text-center">
                    <p className="text-[19px] font-bold">17</p>
                  ...
                  <div className="text-center">
                    <p className="text-[19px] font-bold">59</p>
                  ...
                  <div className="text-center">
                    <p className="text-[19px] font-bold">56</p>
                ...
                <input
                  ...
                  className="w-full h-[33px] mt-[15px]
                  rounded-[8px] bg-white/40 px-[12px]
                ...
                <input
                  ...
                  className="w-full h-[33px] mt-[8px]
                  rounded-[8px] bg-white/40 px-[12px]
                  text-[12px] text-white
                  placeholder-white/60 outline-none"
                />
                ...
                <div className="relative mt-[8px]">
                  <select
                    className="appearance-none w-full h-[33px]
                    rounded-[8px] bg-white/40 px-[12px]
                  ...
                  <ChevronDown
                    size={17}
                    className="absolute right-[10px] top-[8px] text-white pointer-events-none"
                  />
                </div>
